 ...
 * 
 */
public class FastCacheMapOld<K, V> implements Map<K, V>, Serializable,  Closeable{
    ...
    public FastCacheMapOld(String folder, String name, int cacheSize,
    ...
    public FastCacheMapOld(String folder, String name) {
        this(folder, name, FastCacheMapOld.DEFAULT_CACHE_SIZE, null);
    }

    public FastCacheMapOld(String folder) {
        this(folder, "TMP" + rnd.nextInt(1000000), FastCacheMapOld.DEFAULT_CACHE_SIZE,
                null);
    }

    public FastCacheMapOld() {
        this(FastCacheMapOld.DEFAULT_FOLDER, "TMP" + rnd.nextInt(1000000),
                FastCacheMapOld.DEFAULT_CACHE_SIZE, null);
    }
