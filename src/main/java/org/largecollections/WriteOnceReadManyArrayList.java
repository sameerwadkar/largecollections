...
public class WriteOnceReadManyArrayList<V> implements List<V>, Serializable,
    ...
    protected static MapFactory factory = null;
    protected transient SerializationUtils<Object, V> sdUtils = new SerializationUtils<Object, V>();


    public WriteOnceReadManyArrayList(MapFactory factory,String lstName) {
        if(this.factory==null)
            this.factory = factory;
        this.name=lstName;
        valueByIndex = this.factory.getMap(this.name + "V");
        indexByValue = this.factory.getMap(this.name + "I");
    }



    public WriteOnceReadManyArrayList(String factoryFolder, String factoryName, int cacheSize,String lstName) {
        if(this.factory==null)
    ...
    public WriteOnceReadManyArrayList(String factoryFolder, String factoryName, int cacheSize) {
        this(factoryFolder, factoryName, Constants.DEFAULT_CACHE_SIZE,"");
       
    }

    public WriteOnceReadManyArrayList(String factoryFolder, String factoryName) {
        this(factoryFolder, factoryName, Constants.DEFAULT_CACHE_SIZE);
    }
